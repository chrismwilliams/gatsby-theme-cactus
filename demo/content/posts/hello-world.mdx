...
Hello world!!! This is an example blog post showcasing some of the cool stuff we can do. Following is an example blog post written in an mdx file. You can find me @ `demo/content/posts/my-first-post.mdx`. Here you can add/update/delete details and watch the changes live when running in develop mode.
